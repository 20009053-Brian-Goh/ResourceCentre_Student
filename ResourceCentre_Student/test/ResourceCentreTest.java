...
public class ResourceCentreTest {
	...
	public void testRetrieveAllChromebook() {
		...
		String testOutput1 = "";
		assertEquals("Check that ViewAllCamcorderlist", testOutput1, allChromebook1);
		...
		// from the SourceCentre
		allChromebook1 = ResourceCentre.retrieveAllChromebook(chromebookList);

		testOutput1 += String.format("%-10s %-30s %-10s %-10s %-20d\n", "CB001", "Lenovo Legion", "Yes", "", "Win 10");
		testOutput1 += String.format("%-10s %-30s %-10s %-10s %-20d\n", "CB002", "ASUS", "Yes", "", "Win 10");
